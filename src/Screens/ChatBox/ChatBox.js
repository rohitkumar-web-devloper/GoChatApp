...
const ChatBox = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={[MainStyle.flexDesignRow, { justifyContent: 'space-between', paddingVertical: scale(15), paddingHorizontal: scale(10), },]}>
      ...
      <ScrollView>
        <View style={{}}>
          ...
          <View style={{ paddingHorizontal: scale(5), paddingBottom: scale(80) }}>
            ...
            <View
              style={[MainStyle.flexDesignRow, { justifyContent: 'flex-end' }]}>
              <Text style={[ChatBoxStyle.messageStyle, { backgroundColor: Green, color: White, borderTopRightRadius: 0 }]}>
      ...
      {/* MESSAGE SEND BOX */}
      <View style={[MainStyle.flexDesignRow, { paddingHorizontal: scale(8), justifyContent: 'space-between', height: scale(60), borderTopColor: 'lightgray', borderTopWidth: scale(0.2), position: 'absolute', bottom: 0, backgroundColor: 'white', width: "100%" }]}>
        <View style={[MainStyle.flexDesignRow, { justifyContent: 'flex-start', gap: scale(0), width: showSend > 0 ? "75%" : "89%" }]}>
          ...
          <View style={{ width: "100%" }}>
            <TextInput placeholder="Write your message...." style={{ width: '100%', backgroundColor: LGray, borderRadius: scale(10), paddingHorizontal: moderateScale(10), color: Black, }}
              onChangeText={(e) => { setShowSend(e.length) }}
            />
            {
              showSend > 0 ? null :
      ...
      <Modal visible={showModal} animationType="fade" onRequestClose={() => { setShowModal(!showModal); }} transparent={true}>
        <View style={{ width: width, height: height, backgroundColor: 'rgba(0,0,0,.3)' }}>
          <View style={{
            backgroundColor: "white", height: '72%', position: 'absolute', bottom: 0, width: '100%', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 20, shadowColor: "#000000",
            shadowColor: "#000000",
            ...
            <View
              style={[MainStyle.flexDesignRow, { justifyContent: 'flex-start', gap: scale(100), marginBottom: scale(10) },]}>
