import { View, Text, TouchableOpacity, SafeAreaView, ScrollView, Dimensions, Alert } from 'react-native';
import React, { useEffect } from 'react';
import Splash_2Style from './Splash_2Style';
import ImagePath from '../../Constant/ImagePath';
import LoginStyle from '../Login/LoginStyle';
import { Black, LGray, White } from '../../Styles/Color';
...
const Splash_2 = () => {
    ...
    signIn = async () => {
        try {
            ...
            axios.post(`${Main_Base}/create/google-register-app`, { uid: id, photoUrl: photo, firstName: givenName, lastName: familyName, email: email, fullName: name, idToken: userInfo.idToken })
                .then(async (response) => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: Black, height: "100%" }}>
            <ScrollView>
                <View style={{ height: "100%", flex: 1, backgroundColor: 'black', padding: 20, flexDirection: 'column', justifyContent: 'space-between', }}>
                    <View>
                        <View>
                        ...
                        <View>
                            <Text style={[Splash_2Style.heading]}>
                                Connect friends easily & quickly
                            </Text>
                            <Text style={[Splash_2Style.title]}>
                    ...
                    <View style={{ marginTop: scale(0), }}>
                        <View style={{ marginBottom: scale(15) }}>
                            <TouchableOpacity style={[MainStyle.MainButton]} onPress={() => { Navigation.navigate(NavigationStrings.SIGNUP) }} >
                        ...
                        <View style={[MainStyle.flexDesignRow]}>
                            ...
                            <TouchableOpacity onPress={() => { Navigation.navigate(NavigationStrings.LOGIN) }}>
                                <Text style={{ fontSize: 16, fontWeight: 700, color: White, margin: 5, marginLeft: 2, }}>
                                    Log in
                                </Text>
                            </TouchableOpacity>
                        </View>
