    ...
    return (
        <SafeAreaView style={[MainStyle.MainWrapper, { backgroundColor: White, alignItems: "center" }]}>
            ...
            <View style={{ position: "absolute", bottom: scale(100), flexDirection: "row", justifyContent: 'space-between', width: "100%", }}>
                ...
                <TouchableOpacity style={{ backgroundColor: Green, width: scale(50), height: scale(50), justifyContent: "center", alignItems: 'center', borderRadius: scale(50) }} onPress={() => { Navigation.navigate(NavigationStrings.TempScreen_2) }}>
