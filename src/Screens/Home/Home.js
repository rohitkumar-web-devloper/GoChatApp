...
const Home = () => {
  ...
  const rightSwipe = () => {
    return (
      <TouchableOpacity
        style={{ padding: scale(5), backgroundColor: 'red', width: scale(70) }}>
        <Text>df</Text>
        {ImagePath.AppleIcon}
      </TouchableOpacity>
    );
  ...
  return (
    <SafeAreaView style={[MainStyle.MainWrapper, { padding: 0 }]}>
      ...
      <View style={{ backgroundColor: colorVlaue == 1 ? LGray : Green, flex: 1 }}>
          ...
          <View style={[MainStyle.flexDesignRow, { justifyContent: "", gap: 0, width: scale(40) }]}>
            ...
            <Box w="90%" alignItems="center" >
              <Menu w="190" trigger={triggerProps => {
                ...
                <Menu.Item onPress={() => { Navigation.navigate(NavigationStrings.PROFILE) }} ><Text style={{ color: theme == "dark" ? White : Black }}>Profile</Text></Menu.Item>
                <Menu.Item><Text style={{ color: theme == "dark" ? White : Black }}>Arial</Text></Menu.Item>
                <Menu.Item><Text style={{ color: theme == "dark" ? White : Black }}>Arial</Text></Menu.Item>
                <Menu.Item><Text style={{ color: theme == "dark" ? White : Black }}>Arial</Text></Menu.Item>
              </Menu>
            </Box>
        ...
        <Animated.View style={[{ width: "100%", height: scale(70), backgroundColor: LGray, flexDirection: "row", alignItems: "center", position: "absolute", zIndex: 11, overflow: "hidden" }, animatedStyle]}>
          <TextInput placeholder='Search' style={{ backgroundColor: LGray, width: "100%", height: "100%", fontSize: 18, padding: 20 }}
        ...
        <View style={{ flex: 1, backgroundColor: theme == "dark" ? Black : White, padding: moderateScale(10), }}>
          <FlatList showsVerticalScrollIndicator={false} data={Profiledata}
              ...
              return (<Swipeable renderRightActions={() => {
                ...
                <TouchableOpacity style={[MainStyle.flexDesignRow, { backgroundColor: theme == "dark" ? Black : White, paddingHorizontal: scale(5), paddingVertical: scale(11), justifyContent: 'space-between', },]}
                  ...
                  <View style={[MainStyle.flexDesignRow, { justifyContent: 'flex-start', gap: scale(10) },]}>
                    ...
                    <View>
                      <Text style={[HomeStyle.userName, { color: theme == "dark" ? White : Black }]}>Alex Linderson </Text>
                      <Text style={{ color: theme == "dark" ? Gray : DGray }}>How are you</Text>
                    </View>
                  </View>
                  <View style={[MainStyle.flexDesignColumn]}>
                    <Text style={[HomeStyle.messageSeenTime, { color: theme == "dark" ? Gray : DGray }]}>2 min ago </Text>
                    <View style={{ paddingVertical: 3, backgroundColor: 'red', borderRadius: scale(50), paddingHorizontal: 7, }}>
